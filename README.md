...
Минимальный и высокопроизводительный SOCKS5 прокси-сервер на Go, написанный специально для работы с несколькими сетевыми адаптерами (например, несколькими VPN туннелями) на одной машине.
